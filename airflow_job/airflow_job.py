...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-project-gcs")
    bq_project = Variable.get("bq_project", default_var="beaming-storm-456818-t9")
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "868941709011-compute@developer.gserviceaccount.com",
                "network_uri": "projects/beaming-storm-456818-t9/global/networks/default",
                "subnetwork_uri": "projects/beaming-storm-456818-t9/regions/us-central1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="beaming-storm-456818-t9",
        region="us-central1",
